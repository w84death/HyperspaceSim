var game = {
    ...
    showReport: function(data){
        ...
        if(obj.station){
            ...
            if(obj.material > 0 ){
                ...
                this.log('<span class="button" data-do="process-material" data-id='+obj.id+'>&raquo; [ WYGENERUJ PALIWO -'+obj.material+' surowca]</span>');
            }
            if(obj.material > 100 ){
                this.log('<span class="button" data-do="create-ship" data-id='+obj.id+'>&raquo; [ WYPRODUKUJ POJAZD GWIEZDNY -100 surowca ]</span>');
            }
            if(obj.material < 1){
                this.log('&raquo; brak surowca na stacji');
            }
            this.log('&raquo; pozostało paliwa: '+obj.fuel);
            this.log('&raquo; osłony '+obj.shield);
        }
    ...
    buttonPress: function(data){
        ...
        if(data.do == 'create-ship'){
            game.findStation().buildShip();
        }

        game.loopEnabled = true;
    },
    ...
    render: function(){
        ...
        // FRAME
        bufferLine += game.drawHeader('Raporty [rok '+game.year+ ', dzień '+game.days+']');
